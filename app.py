...
def buy():
    ...
    if request.method == "POST":
        ...
        if not symbol:
            return apology("Must fill symbol")
        elif not item:
        ...
        if shares <= 0:
            return apology ("Must not be negative integer")
...
def register():
    ...
    if request.method == "POST":
        ...
        if not username:
            return apology ("Gotta put your user name yo!")
        elif not password:
            return apology ("Password yo!!!")
        elif not confirmation:
            return apology ("Gotta confirm yo!!!")
...
def sell():
    ...
    if request.method == "POST":
        ...
        if shares_owned < shares:
            return applogy("not enough shares")
